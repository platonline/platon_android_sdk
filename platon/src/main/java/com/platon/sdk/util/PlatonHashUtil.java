...
public class PlatonHashUtil {
    ...
    public static String encryptSaleWeb(final String payment, final String data, final String successUrl) {
        if (TextUtils.isEmpty(payment) || TextUtils.isEmpty(data) || TextUtils.isEmpty(successUrl))
            return null;
    ...
    public static String encryptSaleTokenWeb(final String payment, final String data, final String successUrl, final String card_token) {
        if (TextUtils.isEmpty(payment) || TextUtils.isEmpty(data) || TextUtils.isEmpty(successUrl) || TextUtils.isEmpty(card_token))
            return null;
    ...
    public static String encryptOneClickSaleWeb(
        ...
        if (TextUtils.isEmpty(data) || recurringWeb == null || TextUtils.isEmpty(successUrl))
            return null;
    ...
    public static String encryptRecurringWeb(
        ...
        if (TextUtils.isEmpty(formatAmount) || TextUtils.isEmpty(productRecurring.getDescription()) ||
                TextUtils.isEmpty(recurring.getFirstTransId()) || TextUtils.isEmpty(recurring.getToken()))
            return null;
    ...
    public static String encryptScheduleWeb(
        ...
        if (platonProduct == null || recurring == null || platonScheduleWebOptions == null)
            return null;
    ...
    public static String encryptDescheduleWeb(final PlatonRecurringWeb recurring) {
        ...
        if (TextUtils.isEmpty(recurring.getFirstTransId()) || TextUtils.isEmpty(recurring.getToken()))
            return null;
     ...
     *
     * @param email        - payer email
     * @param paymentToken - token google pay
     * @return md5 hash for all {@link BaseAdapter} requests
     */
    public static String encryptGooglePay(final String email, final String paymentToken) {

        final String reverseEmail = new StringBuilder(email).reverse().toString();
        final String clientPass = PlatonCredentials.getClientPass();
        final String reversePaymentToken = new StringBuilder(paymentToken).reverse().toString();

        return md5(
                reverseEmail
                        .concat(clientPass)
                        .concat(reversePaymentToken)
                        .toUpperCase()
        );
    }
