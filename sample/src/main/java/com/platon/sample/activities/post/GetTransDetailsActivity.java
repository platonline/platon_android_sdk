...
public class GetTransDetailsActivity extends BaseActivity implements
        PlatonTransactionDetailsCallback,
    ...
    private Button mBtnGetTransDetails;
    private Trans mTrans;

    @Override
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_trans_details);
    ...
    private void assignViews() {
        ...
        mBtnGetTransDetails = findViewById(R.id.btn_get_trans_details);
    }

    private void configureViews() {
        mBtnRandomize.setOnClickListener(this);
        mBtnGetTransDetails.setOnClickListener(this);
    ...
    @Override
    public void onResponse(final Call call, final PlatonTransactionDetails response) {
